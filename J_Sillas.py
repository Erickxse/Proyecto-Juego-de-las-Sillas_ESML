...
while participantes<=1:
    participantesT = input("Ingrese el numero de participantes: ")
    participantes = int(participantesT) #cast de str a int
...
largo = int(len(listaJugadores)) #Se obtiene la longuitud de la lista y se almacena en una variable
